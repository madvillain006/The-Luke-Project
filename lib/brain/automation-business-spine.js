...
const DEFAULT_PROFILE = {
  ...
  conor_examples: [
    'Cape Fear REALTORS 100-year anniversary research and public-facing history boards',
    'Williston School civil-rights history research',
    'Luke-style local automation, research triage, and evidence-preserving dashboards',
  ],
  cold_offer_angles: [
    'anniversary timeline and archival story package',
    'oral-history intake, transcript, and citation workflow',
    'small-museum research assistant that turns scattered records into reviewed briefs',
  ],
  quality_standards: [
...
function buildClientProfile(input = {}) {
  return {
    ...
    conor_examples: asList(input.conor_examples, DEFAULT_PROFILE.conor_examples),
    cold_offer_angles: asList(input.cold_offer_angles, DEFAULT_PROFILE.cold_offer_angles),
...
function buildContextFile(input = {}) {
  ...
  const markdown = [
    ...
    '',
    section('Relevant Conor Examples', profile.conor_examples),
    '',
    section('Cold Offer Angles', profile.cold_offer_angles),
    '',
