...
function normalizeSchedule(raw, now = new Date()) {
  ...
  return {
    ...
    source: raw?.source || 'google-calendar',
  ...
  const checklist = [
    {
      ...
      detail: latestCheckin ? latestCheckin.summary || 'Check-in captured' : "Tell Luke today's priorities, fixed appointments, and constraints.",
    },
    {
      id: 'weather',
      label: 'Weather',
