...
// Detect image MIME type from magic bytes rather than trusting the caller.
function detectMediaType(base64Str) {
  const bytes = Buffer.from(base64Str.slice(0, 8), 'base64');
...
module.exports = { parseBobby, parseBobbyImage, mergeBobby, detectMediaType };
