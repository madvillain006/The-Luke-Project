...
const events = {
  ...
  automationBusinessEvents: path.join(EVENTS_DIR, "automation-business-events.jsonl"),
  ...
  companionMemory: path.join(EVENTS_DIR, "companion-memory.jsonl"),
  contextBins: path.join(EVENTS_DIR, "context-bins.jsonl"),
  dailyCheckins: path.join(EVENTS_DIR, "daily-checkins.jsonl"),
  developerStackEvents: path.join(EVENTS_DIR, "developer-stack-events.jsonl"),
...
const snapshots = {
  ...
  automationBusinessSpine: path.join(SNAPSHOTS_DIR, "automation-business-spine.json"),
  brainState: path.join(SNAPSHOTS_DIR, "brain-state.json"),
  dailyCalendarWeek: path.join(SNAPSHOTS_DIR, "daily-calendar-week.json"),
  dailyGmailAttention: path.join(SNAPSHOTS_DIR, "daily-gmail-attention.json"),
  canaryLast: path.join(SNAPSHOTS_DIR, "canary-last.json"),
  dailySpine: path.join(SNAPSHOTS_DIR, "daily-spine.json"),
  developerStackSpine: path.join(SNAPSHOTS_DIR, "developer-stack-spine.json"),
