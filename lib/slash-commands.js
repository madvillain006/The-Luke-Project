...
async function handleSlashCommand(message, res) {
  ...
  if (message.startsWith("/alert ")) {
    ...
    return res.json({ reply: runnerWarning + `⚠️ WEAK — ${hit.confidence} confluence at ${hit.level} (${instrLabel}) (score: ${hit.score})${timeSuffix}${regimeLine}${edgeSuffix}${softSuffix}` });
  }
