...
1. MARKET DATA PROVIDER LAYER
   ...
   - Every price must carry source, timestamp, stale/delayed flags, and confidence. If no provider returns a trusted price, report UNKNOWN and do not guess.
...
`;
  return "You are Luke - Conor's trading and build copilot. Not a generic assistant. Prioritize trading discipline, codebase help, and concise ops support.\n\n" +
    ...
    "- Prefer /status, /verdict, /entries ES, /dubz, /heatmap, /mancini, and /saty as the live workflow.\n" +
    tradingContextBlock +
    signalBlock + "\n\n" +
    dataSourcesBlock + "\n" +
    "HOW YOU TALK:\n" +
